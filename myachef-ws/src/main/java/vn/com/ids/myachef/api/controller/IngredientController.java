...
public class IngredientController {
    ...
    public IngredientDTO update(@PathVariable Long id, @Valid @RequestPart IngredientDTO ingredientDTO,
    ...
    public List<IngredientDTO> manualAddIngredient(@Valid @RequestBody List<IngredientDTO> ingredientDTOs) { // [{id_nguyên_liệu: quantity}, {id_nguyên_liệu:
                                                                                                             // quantity}]
