package vn.com.ids.myachef.api.error;
...
import vn.com.ids.myachef.business.exception.model.ApiError;
...
public class GlobalRestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleHttpMessageNotReadable(HttpMessageNotReadableException ex, HttpHeaders headers, HttpStatus status,
        ...
        final ApiError apiError = new ApiError(HttpStatus.BAD_REQUEST, "Malformed JSON request", ex.getLocalizedMessage());
    ...
    public ResponseEntity<Object> handleAccessDeniedException(final Exception ex, final WebRequest request) {
        ...
        return new ResponseEntity<>("Access this resource is denied.", new HttpHeaders(), HttpStatus.FORBIDDEN);
    }

    // // 404
    // @ExceptionHandler(ResourceNotFoundException.class)
    // public final ResponseEntity<ApiError> handleUserNotFoundException(ResourceNotFoundException ex, WebRequest request) {
    ...
    protected ResponseEntity<Object> handleConflict(final RuntimeException ex, final WebRequest request) {
        ...
        final ApiError apiError = new ApiError(HttpStatus.CONFLICT, "There are some conflict on request.", ex.getLocalizedMessage());
        return new ResponseEntity<>(apiError, new HttpHeaders(), apiError.getStatus());
    }
