...
public class ZaloRSAUtil {
     ...
     * @author dungpqt
     * @param prikeyStr
     *            a private key in base64 encode
    ...
    public static String encrypt(PublicKey pubkey, String message) throws IllegalBlockSizeException, BadPaddingException, InvalidKeyException {
    ...
    public static byte[] decrypt(PrivateKey prikey, String message) throws IllegalBlockSizeException, BadPaddingException, InvalidKeyException {
